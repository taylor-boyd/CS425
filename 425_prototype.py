...
#        self.resizingPictureProcessing()
 ...
 # Run photo through backend
    def startPhotoProcessing(self):
        ...
        outputTextFileName = './static/temp.txt'
    ...
    def outputtingList(self):
        ...
        inputTextFileName = './static/temp.txt'
        ...
        if self.saveImage == 0 or self.selectedPictureLocation.find('webcam_photos') != -1:
            # savePhotoBtn = QPushButton("Save Photo")
    ...
    def saveList(self):
        ...
        listFile = open("./static/temp.txt", 'r')
